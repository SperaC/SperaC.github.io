...
<p class="paragraph">SperaC is handsome!</p>
<p id="par">SperaC is very handsome!</p>
```
...
```html
<p>SperaC 很帅！</p>
<p id="para1">SperaC is handsome!</p>
```
...
```html
<p>SperaC 很帅！</p>
<p class="bold">SperaC is handsome!</p>
<p class="bold center">SperaC is handsome!</p>
<p class="center">SperaC is handsome!</p>
```
